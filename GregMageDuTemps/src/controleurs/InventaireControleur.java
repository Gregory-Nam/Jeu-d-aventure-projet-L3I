 ...
 * des méthodes permettant de gerer les differents éléments de la vue selon
...
public class InventaireControleur extends Pane {
	...
	/**
	 * Ajoute l'item passé en parametre dans la liste des items ajoutés et qui
	...
	/**
	 * Suppression de l'item passé en parametre dans la liste des items ajoutés,
	 * désélectionne la case oé était l'item et fait un raffraichissement de
	 * l'inventaire
	 * 
	...
	/**
	 * Mise é jour de l'inventaire aprés une suppression. pour ne pas avoir une case
	 * vide entre deux items. Elle décale tous les items suivant l'item supprimé sur
	 * la case précedente.
	 * 
	 * @param aPartirDe correspond é la position de l'item qui a été supprimé
	 */
	...
	/**
	 * Vide la case é l'indice passé en parametre L'image de l'ImageView est mise é
	 * null Le text du Label prend pour valeur "Vide"
	 * 
	 * @param indice indice de la case é vider
	 */
	...
	/**
	 * Remplir la case é l'indice passé en parametre par l'item passé en parametre
	 ...
	 * selectionner/deselectionner un item. Un item selectionné aura un cadre rouge,
	 * cela engendre la déselection de l'ancien item selectionné s'il existe. Deux
	 * items ne peuvent pas étre selectionné en méme temps.
	 * 
	 * @see selection
	 * @see deselection
	 */
	...
	/**
	 * Selectionne un item sur lequel on a cliqué. Un cadre rouge est ajouté sur le
	 * panneau et un id de valeur "selectionne" est ajouté é l'ImageView.
	 * 
	...
	/**
	 * @return Renvoie l'item qui est selectionné dans l'inventaire La valeur de
	 *         retour est null si aucun item a été selectionné
	 */
	...
	/**
	 * @return vrai si il existe un item a ete selectionne faux aucun item a été
	 *         selectionne
	 */
	...
	/**
	 * Permet de créer un lien entre l'inventaire graphique et l'inventaire
	 * "modéle". <br>
	 * On ajouter un écouteur sur la liste observable de l'inventaire qui permet
	 * d'effectuer les changements graphiques lorsqu'une modification est ralisée
