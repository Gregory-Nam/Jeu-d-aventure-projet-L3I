...
class PersonnageNonJoueurTest {
	...
	void setUp() throws Exception {
		...
		pnj1 = new PersonnageNonJoueur(NomPNJ.KLACE_HEUREOUVERRE, 564, itemTest, new File("Images/PNJ/Klace_face.png"),
		...
		pnj3 = new PersonnageNonJoueur(NomPNJ.CARPENTER, 571,
				...
				new File("Images/PNJ/Carpenter_face.png"), new File("Images/PNJ/Carpenter_face_transparence.png"));

		pnj4 = new PersonnageNonJoueur(NomPNJ.ABITBOL, 148,
				new Item(new File("Images/items/Pendule_or_transparence.png"), new File("Images/items/Pendule_or.png"),
						Materiaux.OR, 218, "Pendule"),
				new File("Images/PNJ/Abitbol_face.png"), new File("Images/PNJ/Abitbol_face_transparence.png"));

		pnj5 = new PersonnageNonJoueur(NomPNJ.ZAVIER_MAIS, 484, null, new File("Images/PNJ/Zavier_face.png"),
	...
	void testPoseQuestion() {
		...
		assertEquals(
				...
				pnj2.poseQuestion());
		assertEquals(
				"Sais-tu combien faut-il de temps (en secondes) pour qu'une horloge sonne midi, \nsi cette derniere sonne six heures en 5 secondes ?",
				pnj3.poseQuestion());
		assertEquals(
				"J'espere que tu es malin...\nSans lui, rien ne peut se faire.\nIl passe vite ou lentement.\nSouvent quand on le perd, on ne le rattrape plus.\nQui suis-je ?",
				pnj4.poseQuestion());
		assertEquals(
				"J'ai un petit probleme mathematique...\nConnais-tu le nombre qui est tel que si on le multiplie par deux, on lui ajoute sa moitie puis son quart et enfin 1, donnera 100 ?",
				pnj5.poseQuestion());
	}
