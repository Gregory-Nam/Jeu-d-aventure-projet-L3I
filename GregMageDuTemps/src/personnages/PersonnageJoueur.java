...
public class PersonnageJoueur extends Personnage {
	...
	/**
	 * Permet de mettre é jour l'ImageView courante selon le deplacement passé en
	 * paramétre.
	 * 
	 * @param d Le deplacement.
	 */
	public void changerSprite(Deplacements d) {
		if (spriteCourant.getImage().equals(spritesPersonnageHM.get(d).getImage()))
			return;
		spriteCourant.setImage(spritesPersonnageHM.get(d).getImage());
	}

	/**
	 * Permet d'enlever l'item que le PersonnageJoueur é dans les mains. Cela
	 * l'enléve également de l'inventaire.
	 */
	...
	/**
	 * Permet de replacer le PersonnageJoueur tout é gauche de la vue.
	 */
	...
	/**
	 * Permet de replacer le PersonnageJoueur tout é droite de la vue.
	 */
	...
	/**
	 * Permet d'ajouter l'item passé en paramétre dans l'inventaire.
	 * 
	 * @param i item é prendre.
	 */
	 ...
	 * 
	 * @return vrai si le PersonnageJoueur a donnée une bonne réponse, faux si le
	 *         PersonnageJoueur a donnée une mauvaise réponse ou n'a pas répondu.
	 */
	...
	/**
	 * Permet de reinitialiser le PersonnageJoueur. Il est replacer a gauche et
	 * l'inventaire est recréée.
	 */
	...
	/**
	 * Permet de faire la liaison du dialogue le PNJ passé en paramétre.
	 * 
